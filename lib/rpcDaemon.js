 ...
 * @async
 * @param {Object} opts
 * @param {string} opts.url - complete url with port 'http://127.0.0.1:13580' or 'https://127.0.0.1:13580'.
 * @param {string} [opts.username='Mufasa'] - username.
 * @param {string} [opts.password='Circle of Life'] - password.
 * @return {RPCDaemon} returns a new instance of RPCDaemon.
 */
   ...
   */
    ...
    * Error: NOT MINING
    * at _request.then (C:\myDev\xolentum-rpc-js\src\rpcDaemon.js:1418:27)
    ...
    *   at _request.then (C:\myDev\xolentum-rpc-js\src\rpcDaemon.js:761:25)
