...
rpcWallet.createWalletClient = function (config) {
  ...
  return {
    ...
    */
    ...
    /**
    * Create a new wallet. You need to have set the argument "–wallet-dir" when launching xolentum-wallet-rpc to make this work.
    * @async
    * @param {Object} opts
    ...
    * @example <caption><b>Output</b></caption>
    * {
    *  uri: 'xolentum:as3ne6ewX5GBfSkQZsWi5YWjTG9xRSA5fMYBM7sfawiqWr2n1qd5Y4JJEWKXE1dKRCNuVWQLeknUmWascmFBNwKi1zyBaB9n2?tx_payment_id=8ca523f5e9506fed&tx_amount=1.000000000&recipient_name=stagenet%20B&tx_description=test'
    * }
    */
    ...
    /**
    * Open a wallet. You need to have set the argument "–wallet-dir" when launching xolentum-wallet-rpc to make this work.
    * @async
    * @param {Object} opts
    ...
    */
    ...
    /**
    * Start mining in the Xolentum daemon.
    * @async
    * @param {Object} opts
    ...
    * @param {Object} opts
    * @param {boolean} [opts.get_tx_keys] - Return the transaction keys after sending.
    * @param {boolean} [opts.do_not_relay] - If true, the newly created transaction will not be relayed to the Xolentum network. (Defaults to false).
    ...
    */
    ...
    /**
    * Parse an address to validate if it's a valid Xolentum address.
    * @async
    * @param {Object} opts
